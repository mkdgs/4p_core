...
(function( $ ){
	...
	methods.init = function (params) { 		 
		 return this.each(function() {	
			 ...
			 $(that.events).bind('validationError', function (ev,element,type,code) { 				
			 ...
			 $(that.events).bind('resetForm', function (ev,element) { 				
				 _log('resetForm');	
				 options.onResetForm(ev,element);
			 });
			 $(that.events).bind('resetElement', function (ev,element) { 
				 _log('resetElement');	
				 options.onResetElement(ev,element);
			 });
			 
			 $(that.events).bind('validationElement', function (ev,element) { 
			 ...
			 $(that.events).bind('validationForm', function (ev,form) { 				
				    _log('validationForm');
	...
	$.fn.validation = function(method) {		
	    if ( methods[method] ) {
	      ...
	      $.error( 'Method ' +  method + ' fail jQuery.tagging' );
	    }    	  
	};
